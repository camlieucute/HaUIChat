      ...
      <div className="container mx-auto px-4 py-8 max-w-7xl">
        <div className="text-center mb-12">
          ...
          <p className="text-gray-600 text-lg">
            Trợ lý thông minh hỗ trợ hoạt động của Trường Đại học Công nghiệp Hà
            Nội
          </p>
        </div>
              ...
              <div className="flex flex-col md:flex-row gap-6">
                <div className="flex-1">
                  ...
                  <p className="text-gray-600 mb-4">
                    ...
                    thông báo, hoạt động, sự kiện của Trường Đại học Công nghiệp
                    Hà Nội một cách nhanh chóng và hiệu quả.
                  </p>
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                  ...
                  <div className="bg-gray-50 p-4 rounded-lg">
                    ...
                    <div className="space-y-2 text-gray-600">
                      <p>"Thông báo thu học phí học kì 2 năm học 2024-2025?"</p>
            ...
            <CardContent>
              <div className="space-y-4">
                <p className="text-gray-600">
                  ...
                  Hội - Đội. Chúng tôi luôn lắng nghe góp ý của bạn để cải thiện
