...
def get_chunk_tool(question: str) -> str:
    """
    Tìm kiếm thông tin về 'Trường Đại học Công nghiệp Hà Nội'. 
    Đối với bất kỳ câu hỏi nào liên quan đến 'Trường Đại học Công nghiệp Hà Nội', hãy sử dụng công cụ này.
    """
